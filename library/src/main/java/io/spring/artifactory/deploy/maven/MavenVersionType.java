...
public enum MavenVersionType {
	...
	/**
	 * A timestamp based snapshot, for example {@code 1.0.0-20171005.194031-1}.
	 */
	TIMESTAMP_SNAPSHOT,

	/**
	 * A regular snapshot, for example {@code 1.0.0-SNAPSHOT}.
	 */
	SNAPSHOT,

	/**
	 * A fixed version, for example {@code 1.0.0}.
	 */
	FIXED;
	...
	/**
	 * Determines the version type from a version string.
