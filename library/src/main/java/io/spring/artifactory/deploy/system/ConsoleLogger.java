...
public class ConsoleLogger {
	...
	/**
	 * Creates a new {@link ConsoleLogger}, enabling debug output when
	 * {@code ACTIONS_STEP_DEBUG} environment variable is set to {@code true}.
	 */
	public ConsoleLogger() {
		this.debugEnabled = Boolean.parseBoolean(System.getenv("ACTIONS_STEP_DEBUG"));
	}
