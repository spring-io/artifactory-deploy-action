 ...
 */
public class DeployableArtifactsSigner {
	...
	/**
	 * Adds ASCII-armored signature artifacts for each artifact in the given map.
	 * @param batchedArtifacts artifacts grouped by category
	 * @return a new map containing the original artifacts plus their signatures
	 */
	public MultiValueMap<Category, DeployableArtifact> addSignatures(
