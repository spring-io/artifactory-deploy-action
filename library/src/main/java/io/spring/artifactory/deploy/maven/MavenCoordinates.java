...
public final class MavenCoordinates implements Comparable<MavenCoordinates> {
	...
	/**
	 * Returns the snapshot version string as it appears in the filename.
	...
	/**
	 * Parses Maven coordinates from a deployment path.
	 * @param path the artifact deployment path
	 * @return the parsed coordinates
	 * @throws IllegalStateException if the path cannot be parsed
	 */
